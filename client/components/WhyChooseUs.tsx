...
const features = [
  {
    ...
    description: "We don't just teach subjects—we develop minds. Every session is designed to strengthen memory, attention, logical reasoning, critical thinking, and problem-solving skills.",
    color: "from-yellow-400 to-orange-500"
  },
  {
    icon: BookOpen,
    title: "Advanced Curriculum that inspires",
    description: "We go beyond standard classroom instruction. Our Math and ELA programs teach concepts that are one to two grade levels ahead of public school curriculum.",
  ...
  },
  {
    ...
    description: "Our teachers are passionate about making a difference and use gentle, encouraging methods to help every child succeed.",
    color: "from-purple-400 to-indigo-500"
  },
  {
    icon: Users,
    title: "Personalized Small Group Classes",
    description: "We keep our class sizes small to give every child the attention they deserve and create meaningful learning connections.",
...
export default function WhyChooseUs() {
  return (
    <section className="bg-gradient-to-br from-icreative-pink-light via-purple-50/50 to-blue-50/30 py-20 lg:py-28 px-6 lg:px-20 relative overflow-hidden">
      ...
      {/* Floating Elements */}
      <div className="absolute top-20 right-20 w-8 h-8 border-2 border-icreative-purple/20 rounded-full animate-spin" style={{ animationDuration: '20s' }} />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16 lg:mb-20">
          <div className="inline-flex items-center gap-2 bg-white/60 backdrop-blur-sm border border-icreative-purple/20 px-4 py-2 rounded-full mb-6">
            ...
            <span className="text-icreative-purple font-inter text-sm font-medium">Why Choose iCreative Learning</span>
          </div>
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="relative mb-6">
                <div className={`w-16 h-16 lg:w-20 lg:h-20 bg-gradient-to-r ${feature.color} rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
        ...
        <div className="mt-16 lg:mt-20 text-center">
          <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-8 lg:p-12 border border-white/50 max-w-4xl mx-auto">
            ...
            <p className="text-icreative-grey font-inter text-lg mb-8 max-w-2xl mx-auto">
              Join our community of learners and see how our research-backed methods can transform your child's educational journey.
            </p>
