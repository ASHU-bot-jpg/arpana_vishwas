...
const programs = [
  {
    ...
    description: "Building mathematical thinking through hands-on exploration and real-world applications",
  ...
  },
  {
    ...
    description: "Developing language skills through creative expression and interactive learning",
  ...
  {
    title: "Abacus",
    description: "Ancient tool for modern minds - master mental math with confidence",
  ...
  {
    title: "CogAT",
    description: "Cognitive abilities test preparation for gifted and talented programs",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-icreative-grey font-inter text-lg lg:text-xl max-w-3xl mx-auto leading-relaxed">
              Discover our comprehensive educational programs designed to unlock your child's potential 
            ...
            {programs.map((program, index) => (
              ...
              >
                ...
                <div className="relative aspect-[4/3] overflow-hidden">
                  ...
                  />
                  <div className={`absolute inset-0 bg-gradient-to-t ${program.color} opacity-0 group-hover:opacity-80 transition-opacity duration-500`} />
                  ...
                  <div className="pt-6 border-t border-gray-100">
                    <div className="flex items-center justify-between">
                      <div className="space-y-1">
                        <p className="text-icreative-grey font-inter text-xs">Ready to start?</p>
                        <p className="text-icreative-purple font-inter text-sm font-semibold">Join thousands of students</p>
                      </div>
                      <Link
                        to="/register"
          ...
          <div className="mt-20 text-center bg-gradient-to-r from-icreative-purple to-icreative-magenta rounded-3xl p-12 text-white">
            ...
            <p className="font-inter text-lg mb-8 opacity-90 max-w-2xl mx-auto">
              Schedule a free assessment today and discover which program is perfect for your child's unique learning style
            </p>
